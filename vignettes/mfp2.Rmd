...
## Linear Regression
The default `family` in our package is `Gaussian`, which fits a Gaussian 
...
Now, we demonstrate how to fit the same model using the formula interface. We
utilize the `fp()` function which takes in some parameters
