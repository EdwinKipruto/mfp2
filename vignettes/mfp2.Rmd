...
freedom assigned to this variable should be 4. The default df = 4` for each 
predictor.
...
to 1. In the formula interface, there is no need to specify the `df`, as the
...
### Setting significance levels for variable and function selection
