...
key functions, fundamental operations, and resulting outputs. We will delve into
each function in detail, highlighting their specific use. This will provide 
users with a deeper understanding of the package's functionality. The package includes a built-in dataset that is specifically designed for analysis within
the `mfp2` framework. 
