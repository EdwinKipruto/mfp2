...
This enables the identification and incorporation of local features that may have been missed by the global FP function. The approach is not currently implemented in the `mfp2` package, but it is a potential area for future extensions.
