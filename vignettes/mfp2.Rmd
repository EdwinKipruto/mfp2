...
instance, it is not sensible to fit an FP2 function to a variable with only 3 distinct values (Stata manual). 
...
most complex function allowed for continuous variable x1, setting `alpha = 1` will select the best FP2 function.
...
for a variable, such as (0, 0, 0.5), the program will remove the duplicates and 
...
fracplot(fit1, terms = "x5", color_points  = "black")[[1]] + ggplot2::ylab("Partial predictor + residuals")

fracplot(fit2, terms = "x5", color_points  = "black")[[1]] + ggplot2::ylab("Partial predictor + residuals")
