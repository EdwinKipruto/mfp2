...
figure =ggpubr::ggarrange(p,q,ncol = 2, nrow = 1, widths = 10,heights = 4, common.legend = F, legend = "none", vjust = 2)

```

```{r, echo=FALSE, fig.cap="Examples of FP2 curves for different powers (left panel) and for the fixed FP2 powers (-2, 2) but different regression coefficients (right panel)", echo=FALSE,fig.align='center'}
figure
```
