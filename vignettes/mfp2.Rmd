...
# create dummy variables for x4 based on ordinal coding
art <- create_dummy_variables(art, var_ordinal = c("x4"), drop_variables = TRUE)

# convert x9 to factor and assign level 1 as reference group
art$x9 <- factor(art$x9, ordered = FALSE, levels = c(1, 2, 3))

# create dummy variables for x9 using categorical coding 
art <- create_dummy_variables(art, var_nominal = c("x9"), drop_variables = TRUE)
head(art)
